# Script to update Section names for all modules, including Assessment Checking and AI modules
from app import db, create_app
from app.models import Section

def fix_section_names_all():
    app = create_app()
    with app.app_context():
        ...
        db.session.commit()
        print("All section names and lesson links updated, including Assessment Checking and AI modules.")

if __name__ == "__main__":
    fix_section_names_all()
