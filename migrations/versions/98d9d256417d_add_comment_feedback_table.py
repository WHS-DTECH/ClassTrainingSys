...
def upgrade():
    ...
    course_fks = inspector.get_foreign_keys('courses')
    has_teacher_fk = any(
        fk.get('referred_table') == 'users' and fk.get('constrained_columns') == ['teacher_id']
        for fk in course_fks
    )
